...
describe('Markdown parser', function(){
	...
	describe('Parse header tags', function() {
		it('# header', function(done) {
			var headerTag = md.parseFileContentTags('# header'); 
		...
		it('blabla #header \'\\n\' blabla', function(done) {
			var headerTag = md.parseFileContentTags('blabla #header\n blabla'); 
	...
	describe('Parse link tags', function() {
		...
		var linkTag= md.parseFileContentTags('[Link](http://www.google.es)'); 
	...
	describe('Parse pre tags', function() {
		it('\'```\' name \\n bla bla \\n \'```\'', function(done) {
			var preTag= md.parseFileContentTags('``` Syntax highlighting. \nand a <b>Tag</b> ```\n'); 
